...
describe('vott-foundation', () => {
  ...
  describe('#rectIntersection()', () => {
    ...
    it('should be undefined for disjoint rects', () => {
      const a = { x: 10, y: 20, w: 320, h: 200 };
      const b = { x: 640, y: 480, w: 10, h: 20 };
    ...
    it('should equal meaningful rect for intersecting rects', () => {
      const a = { x: 10, y: 20, w: 320, h: 200 };
      const b = { x: 320, y: 200, w: 640, h: 480 };

      const intersection = foundation.rectIntersection(a, b);
      assert.deepEqual(intersection, { x: 320, y: 200, w: 10, h: 20 });
    });
  ...
  describe('#rectUnion()', () => {
    ...
    it('should be super rect for disjoint rects', () => {
      const a = { x: 0, y: 0, w: 50, h: 60 };
      const b = { x: 100, y: 200, w: 10, h: 20 };

      const intersectionAB = foundation.rectUnion(a, b);
      assert.deepEqual(intersectionAB, { x: 0, y: 0, w: 110, h: 220 });

      const intersectionBA = foundation.rectUnion(b, a);
      assert.deepEqual(intersectionBA, { x: 0, y: 0, w: 110, h: 220 });
    });
    ...
    it('should equal meaningful rect for intersecting rects', () => {
      ...
      assert.deepEqual(intersection, { x: 10, y: 20, w: 950, h: 660 });
    });
  ...
  describe('#rectAnalysis()', () => {
    ...
    it('should return all mismatches', () => {
      const rectanglesA = [{ x: 10, y: 20, w: 320, h: 200 }, { x: 10, y: 20, w: 320, h: 200 }];
      const rectanglesB = [];
    ...
    it('should return all matches', () => {
      const rectangles = [{ x: 10, y: 20, w: 320, h: 200 }, { x: 10, y: 20, w: 320, h: 200 }];
    ...
    it('should return some matches and some mismatches', () => {
      const rectanglesA = [{ x: 10, y: 20, w: 320, h: 200 }, { x: 100, y: 200, w: 320, h: 200 }];
      const rectanglesB = [{ x: 20, y: 30, w: 320, h: 200 }, { x: 640, y: 480, w: 320, h: 200 }];

      const analysisAB = foundation.rectAnalysis(rectanglesA, rectanglesB);
      assert.deepEqual(analysisAB.matches, [{ x: 20, y: 30, w: 320, h: 200 }]);
      assert.deepEqual(analysisAB.mismatches, [{ x: 640, y: 480, w: 320, h: 200 }]);

      const analysisBA = foundation.rectAnalysis(rectanglesB, rectanglesA);
      assert.deepEqual(analysisBA.matches, [{ x: 10, y: 20, w: 320, h: 200 }]);
      assert.deepEqual(analysisBA.mismatches, [{ x: 100, y: 200, w: 320, h: 200 }]);
    });
